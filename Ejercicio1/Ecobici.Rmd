...
```
__ De la gráfica anterior resaltaría el hecho de que hay estaciones para las que el 50% de sus arribos son en fines de semana
...
Recordando que:
El modelo de un proceso autorregresivo dice que en el momento t el valor Yt,consiste de una, δ (delta),más un coeficiente autorregresivo, φ (phi), por el valor del dato anterior (Yt - 1), más el ruido aleatorio, ɛt.
La idea es tomar  φ, medida de cambio, para verificar que tanto aumenta o disminuye la tendencia.
